 ...
 *
 * The followings are the available columns in table 'attribute_type':
...
class AttributeType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('attribute_type_id, name', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'attributes' => array(self::HAS_MANY, 'Attribute', 'attribute_type_id'),
		);
	}
